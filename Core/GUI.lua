...
local function CreateGlobalSettings(parentContainer)
    ...
    highlightAssistCheckbox:SetCallback("OnValueChanged", function(_, _, value)
        BCDM:SetHighlightAssistEnabled(value)
    end)
...
local function CreateCastBarSettings(parentContainer)
    ...
    local instantCastOverlayCheckbox = AG:Create("CheckBox")
    instantCastOverlayCheckbox:SetLabel(LL("Show Instant Cast GCD Overlay"))
    instantCastOverlayCheckbox:SetValue(CastBarDB.ShowInstantCastOverlay)
    instantCastOverlayCheckbox:SetCallback("OnValueChanged", function(self, _, value) CastBarDB.ShowInstantCastOverlay = value BCDM:UpdateCastBar() end)
    instantCastOverlayCheckbox:SetRelativeWidth(0.33)
    toggleContainer:AddChild(instantCastOverlayCheckbox)
    ...
    local instantForegroundColour = CastBarDB.InstantCastForegroundColour or CastBarDB.ForegroundColour
    local instantForegroundColourPicker = AG:Create("ColorPicker")
    instantForegroundColourPicker:SetLabel(LL("Instant Cast Foreground Colour"))
    instantForegroundColourPicker:SetColor(instantForegroundColour[1], instantForegroundColour[2], instantForegroundColour[3], instantForegroundColour[4])
    instantForegroundColourPicker:SetCallback("OnValueChanged", function(self, _, r, g, b, a) CastBarDB.InstantCastForegroundColour = {r, g, b, a} BCDM:UpdateCastBar() end)
    instantForegroundColourPicker:SetRelativeWidth(0.33)
    instantForegroundColourPicker:SetHasAlpha(true)
    toggleContainer:AddChild(instantForegroundColourPicker)
